...
a:not(.gatsby-resp-image-link):not(.anchor):not(.footnote-ref):not(.footnote-backref):not(.index-link) {
  background: linear-gradient(to bottom, ${(p) => p.theme.colors.primary} 0%, ${(p) => p.theme.colors.primary} 100%);
